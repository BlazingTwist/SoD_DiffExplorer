...
namespace SoD_DiffExplorer._revamp._config._downloadSettings
{
	class DownloadSettings : YamlObject, IMenuObject
	{
		public IMenuPropertyAccessor<bool> pauseDownloadOnError = new MenuOptionProperty<bool>(nameof(pauseDownloadOnError), new MenuPropertyToggleBehavior());
		public IMenuPropertyAccessor<bool> doDownload = new MenuOptionProperty<bool>(nameof(doDownload), new MenuPropertyToggleBehavior());
		public IMenuPropertyAccessor<string> targetDirectory = new MenuOptionProperty<string>(nameof(targetDirectory), new MenuPropertyStringEditorBehavior());
